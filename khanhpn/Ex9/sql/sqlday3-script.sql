...
insert into `product` (`product_code`,`category_detail_id`,`warehouse_detail_id`,`product_name`,`product_description`,`image_url`,`quantity`,`sold_quantity`,`created_date`,`updated_date`) values
...
select * from `hb-product`.categorproducty;
...
where p.product_name like '%Điện Thoại%' and p.category_detail_id = 1;
